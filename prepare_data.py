...
# How many problems to download and process from the raw dataset.
# Set to None to process the entire dataset.
# PROBLEMS_TO_PROCESS = None
PROBLEMS_TO_PROCESS = 100000
...
def prepare_dataset():
    """
    Downloads the dataset, filters for numeric-only answers, selects the best
    reasoning trace, and saves to a clean JSONL file.
    """
    ...
    # --- Step 4: Write the clean records to the output file ---
